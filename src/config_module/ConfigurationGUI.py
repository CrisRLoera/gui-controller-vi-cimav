...
class ConfigurationGUI:
    def __init__ (self,data,nav,host):
        ...
        self.smtp_entry = CTkEntry(self.conf_view, font=self.def_font,  height=40)
        ...
        self.sender_entry = CTkEntry(self.conf_view, font=self.def_font,height=40)
        ...
        self.maintenance_email_entry = CTkEntry(self.conf_view, font=self.def_font, height=40)
